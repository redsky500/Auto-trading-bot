...
class Config:  # pylint: disable=too-few-public-methods,too-many-instance-attributes
    def __init__(self):
        ...
        self.SOURCE_COIN_SPLIT_FRACTION = float(
            os.environ.get("SOURCE_COIN_SPLIT_FRACTION") or config.get(USER_CFG_SECTION, "source_coin_split_fraction")
        )
        self.SIGNIFICANT_BALANCE_THRESHOLD = float(
            os.environ.get("SIGNIFICANT_BALANCE_THRESHOLD")
            or config.get(USER_CFG_SECTION, "significant_balance_threshold")
        )
        self.MINIMUM_BALANCE_THRESHOLD_FOR_SCOUTING = float(
            os.environ.get("MINIMUM_BALANCE_THRESHOLD_FOR_SCOUTING")
            or config.get(USER_CFG_SECTION, "minimum_balance_threshold_for_scouting")
        )
